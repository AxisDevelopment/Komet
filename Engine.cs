namespace AxisDevelopment.Komet {
    public static class Engine
    {
        ...
        public static void PrintSystemMessage(string message) {
            Console.WriteLine(Static.systemMessageSlug + message);
        }

        public static void PrintSystemError(string error) {
            Console.Error.WriteLine(Static.systemMessageSlug + error);
        }
        
        public static void PrintSystemError(Exception error) {
            Console.Error.WriteLine(Static.systemMessageSlug + error.Message);
        }
    }
}